...
class CustomApproverReportsPage extends StatefulWidget {
  const CustomApproverReportsPage({super.key});

  @override
  State<CustomApproverReportsPage> createState() =>
      _CustomApproverReportsPageState();
}

class _CustomApproverReportsPageState extends State<CustomApproverReportsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: const CustomApproverNavBar(currentIndex: 2),
      ),
    );
  }
