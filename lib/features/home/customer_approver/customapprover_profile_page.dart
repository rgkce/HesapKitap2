...
class CustomApproverProfilePage extends StatelessWidget {
  const CustomApproverProfilePage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: const CustomApproverNavBar(currentIndex: 3),
      ),
    );
  }
