...
class CustomApproverHomePage extends StatelessWidget {
  const CustomApproverHomePage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: const CustomApproverNavBar(currentIndex: 0),
    );
  }
