...
class ProcurementProfilePage extends StatelessWidget {
  const ProcurementProfilePage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          child: Column(
            children: [
              ...
              Text(user?.name ?? "Kullanıcı", style: AppStyles.heading2),
                    ...
                    _buildProfileItem(
                      ...
                      onTap:
                          () => AppDialog.show(
                            ...
                            title: "Şifre Değiştir",
                            message:
                                "Şifrenizi değiştirmek için yönlendirileceksiniz. Devam etmek istiyor musunuz?",
                            onConfirm:
                                () => Navigator.pushNamed(
                                  context,
                                  '/change_password',
        ...
        bottomNavigationBar: const ProcurementNavBar(currentIndex: 4),
      ),
    );
  }
